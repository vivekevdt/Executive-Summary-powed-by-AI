...
export const generateExecutiveSummary = async (req, res) => {
  try {
    ...
    console.log("✅ PDFs uploaded to OpenAI");
    ...
    console.log("✅ Executive summary generated by LLM");
...
export const getReportSummary = async (req, res) => {
  try {
    ...
    console.log(`🔍 [DEBUG] Searching for summary: ${summaryPath}`);
    console.log(`🔍 [DEBUG] File exists? ${fs.existsSync(summaryPath)}`);

    if (!fs.existsSync(summaryPath)) {
      console.warn(`⚠️ [WARNING] Summary file not found for ${fileId}`);
